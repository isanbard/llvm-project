...
; investigation and shouldn't block this GEP slice. Tracking that as a
; known gap rather than chasing it here: no test in this milestone's
; suite has needed -O0 pinned explicitly before, so this is the first
; time either latent issue was even reachable.
