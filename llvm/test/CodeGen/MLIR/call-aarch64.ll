...
; the caller's own signature scalar/pointer-only, per the established
; scope boundary for a function's own formal parameters) and is especially
; worth diffing on this target: AAPCS64 packs small aggregates into
; consecutive argument registers, a real target-specific ABI path X86
; testing can't exercise even where it does work.
