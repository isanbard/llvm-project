...
;
; The experimental MLIR ISel pass currently always defers to the normal
; instruction selector (see llvm/lib/CodeGen/MLIR/MLIRInstructionSelect.cpp),
; so -enable-mlir-isel must produce byte-identical
