...
;
; Verifies real translation for structured multi-block control flow:
; branches, conditional branches (gmir.brcond), integer comparisons
; (gmir.icmp), and PHI nodes -- represented as MLIR block arguments fed by
; gmir.br/brcond's successor operands, not a separate gmir.phi op (see
