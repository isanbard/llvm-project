...
//===----------------------------------------------------------------------===//
//
// This initial version of the MLIR ISel pass registers and loads the
// `gmir` MLIR dialect (proving the dialect + MLIRContext wiring builds and
// runs), then unconditionally defers to the existing selector by marking
// the MachineFunction's ISel as failed. Real op translation lands on top
// of this scaffolding in later patches.
//
//===----------------------------------------------------------------------===//
